    ...
    Public Sub Specifics(ctl As Object)
        ...
        Select Case ctl.name
            ...
            Case "ResponseView"
                ...
                SqlCode = "SELECT DateDiff('d',[Queries].[CreateDate],Now())-(2*(DateDiff('ww', [Queries].[CreateDate],Now()))) - " &
                "(iif(weekday([Queries].[CreateDate])=1,1,0) + iif(weekday(now())=1,1,0)) AS Light, " &
                "QName, CreatedByRole, QueryID, Study, Person, " &
                ...
                With RespView.StaffQueryGrid
                    ...
                    .Columns.Add(clm2)
                    .Columns("LightClm").AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader
                ...
                RespView.FilterCombo1.DroppedDown = False
                RespView.FilterCombo2.DroppedDown = False
                RespView.FilterCombo3.DroppedDown = False
                RespView.FilterCombo30.DroppedDown = False
                RespView.FilterCombo90.DroppedDown = False
                RespView.FilterCombo5.DroppedDown = False
                RespView.FilterCombo4.DroppedDown = False
